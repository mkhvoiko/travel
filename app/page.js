...
export default function Home() {
  ...
  return <main>
    ...
    <footer><div className="wrap footer-grid"><div className="footer-brand"><Logo /><p>Authentic Jamaican experiences, designed and guided with love.</p><span><MapPin size={14} />Montego Bay, Jamaica</span></div><div><b>Explore</b><a href="#experiences">All experiences</a><a href="#transfers">Airport transfers</a><a href="#why-us">About us</a><a href="#stories">Reviews</a></div><div><b>Support</b><a href="#">Help centre</a><a href="#">Cancellation policy</a><a href="#">Privacy</a><a href="#">Terms</a></div><div><b>Stay close</b><p>Island inspiration and new experiences, sent occasionally.</p><label className="subscribe"><input placeholder="Email address" /><button onClick={() => toast("You’re on the island list.")}><ArrowRight /></button></label></div></div><div className="wrap footer-bottom"><span>© 2026 Love Travel Jamaica</span><span>Made with love in Jamaica 🇯🇲 · Created by <a href="https://emiops.com" target="_blank" rel="noreferrer">EmiOps.com</a></span></div></footer>
